...
# Axes settings 
AXES_FAILURE_LIMIT = 3                  # lock after 5 wrong passwords
AXES_COOLOFF_TIME = 60 * 120             # 1-hour lockout
...
DEFAULT_FROM_EMAIL = 'VeryCodedly <connect@verycodedly.com>'
...
if not DEBUG:
    # SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https') #  +1
    # USE_X_FORWARDED_HOST = True # +1
