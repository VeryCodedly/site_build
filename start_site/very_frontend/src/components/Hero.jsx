...
export default function Hero() {
    return (
        <section className="w-full max-w-7xl mx-auto flex flex-wrap gap-8 items-center pb-1 py-22 px-12 lg:py-16 lg:px-16 border-b border-zinc-900">
        {/* <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center py-16 px-14 md:px-14"> */}
          ...
          <h1 className="hero text-5xl sm:text-6xl md:text-6xl lg:text-6xl text-white font-extrabold leading-tight">
            <span className="hero opacity-0 w-full max-w-[400px] min-h-[180px] sm:min-h-[230px] min-w-[300px] sm:min-w-[400px] flex absolute">
          ...
          <div className="flex space-x-5">
            <Link href="/learn" className="font-semibold cursor-pointer border-3 border-gray-500/100 bg-lime-400 text-black px-6 py-1 rounded-full hover:bg-white hover:font-bold hover:text-black shadow-[0_4px_0_0_#39ff14] hover:translate-y-0.5 hover:shadow-[0_2px_0_0_#0f0] active:translate-y-1.5 transition-all duration-200">
              <span className="lg:hidden">Learn</span>
              <span className="hidden lg:inline">Start Learning</span>
            </Link>
            <Link href="/blog" className="font-semibold cursor-pointer border-3 border-gray-500/100 px-8 py-1 rounded-full text-white hover:bg-white hover:text-black hover:font-bold hover:translate-y-0.5 shadow-[0_4px_0_0_#0f0] hover:shadow-[0_2px_0_0_#39ff14] active:translate-y-1.5 transition-all duration-200">
